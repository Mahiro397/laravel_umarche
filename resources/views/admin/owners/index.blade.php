<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="md:p-6  p-6 bg-white border-b border-gray-200">
 ...
 <section class="text-gray-600 body-font">
  <div class="container px-5 md:px-5  mx-auto">
        ...
        @foreach ($owners as $owner)
            <tr>
                ...
                <form id="delete_{{$owner->id}}" method="post" action="{{route('admin.owners.destroy',['owner' =>$owner->id])}}">
                  ...
                  @method('delete')
                <td class="px-4 py-3">
                <a herf="#" data-id="{{ $owner->id }}" onclick="deletePost(this)" type="submit" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded ">削除</a>
                </td>
                </form>
            </tr>
          @endforeach
